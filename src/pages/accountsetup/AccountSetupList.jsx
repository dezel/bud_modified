...
//console.log(err);
  ...
  return (
    <div className="accountsetuplist">
      <Sidebar />
      <div className="accountsetuplistContainer">
        <Navbar />
        <div className="innerContainer">
          <PageHeader
            icon={<ReceiptLongIcon className="headerIcon" />}
            mainTitle="Account Setup"
            subTitle="Branches and Departments Information"
          />
          <div className="accountsetuplistpaper">
            <Toolbar>
              <Controls.Input
